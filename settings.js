...
global.alivemsg = `📤මම ඔයාට උදවු කරන්නද😇
🤷‍♀️මොකද්ද මගෙන් වෙන්න ඕනේ?😉` //Costomize Alive Message (type your message in `` )
...
global.ownername = "🕊️׀ו◈𝙻𝙾𝙺𝚄 𝚂𝙲𝙾𝙾𝙱𝚈◈ו׀🕊️" // owner name
...
global.botname = '🕊️𝙻𝙾𝙺𝚄 𝚂𝙲𝙾𝙾𝙱𝚈-𝙱𝙾𝚃🕊️' //ur bot name
global.packname = "𝙳𝙰𝙼𝙸𝚃𝙷" // sticker packname
global.author = "🕊️׀ו◈𝙻𝙾𝙺𝚄 𝚂𝙲𝙾𝙾𝙱𝚈◈ו׀🕊️" // sticker author
global.dragonemoji = '😇' // Menu emoji
global.footer = '[ ◉🍃𝙻𝙾𝙺𝚄 𝙿𝙰𝙽𝙲𝙷𝙰🍃◉ ]' //
...
global.mess = {
    ...
    caption: 'Generated by: ◉ *𝙻𝙾𝙺𝚄 𝙿𝙰𝙽𝙲𝙷𝙰*'
} // END \\
    global.limitawal = {
    premium: "Infinity",
    free: 12,
